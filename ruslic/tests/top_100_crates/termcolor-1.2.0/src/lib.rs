...
impl Default for ColorSpec {
    fn default() -> ColorSpec {
      crate::ColorSpec { fg_color: ::std::option::Option::None, bg_color: ::std::option::Option::None, bold: true, intense: true, underline: true, dimmed: true, italic: true, reset: true, strikethrough: true }
    }

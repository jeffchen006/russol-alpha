...
impl Clone for Index {
    fn clone(&self) -> Self {
      let de_index = self.index;
      let de_span = self.span;
      crate::expr::Index { index: de_index, span: de_span }
    }
...
impl Clone for LitBool {
    fn clone(&self) -> Self {
      let de_value = self.value;
      let de_span = self.span;
      crate::lit::LitBool { value: de_value, span: de_span }
    }
...
impl Clone for MacroDelimiter {
    fn clone(&self) -> Self {      match self {        crate::mac::MacroDelimiter::Paren(_0) => {          let de = *_0;          crate::mac::MacroDelimiter::Paren(de)        }        crate::mac::MacroDelimiter::Brace(_0) => {          let de = *_0;          crate::mac::MacroDelimiter::Brace(de)        }
        crate::mac::MacroDelimiter::Bracket(_0) => {
          let de = *_0;
          crate::mac::MacroDelimiter::Bracket(de)
        }
      }
    }
}

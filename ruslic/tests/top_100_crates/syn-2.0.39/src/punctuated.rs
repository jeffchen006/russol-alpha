...
impl<T, P> Pair<T, P> {
    ...
    pub fn into_value(self) -> T {      match self {
        crate::punctuated::Pair::Punctuated(_0, _) => _0,
        crate::punctuated::Pair::End(_0) => _0,
      }
    }

    /// Borrows the syntax tree node from this punctuated pair.
    pub fn value(&self) -> &T {      match self {
        crate::punctuated::Pair::Punctuated(_0, _) => _0,
        crate::punctuated::Pair::End(_0) => _0,
      }
    }
    ...
    pub fn value_mut(&mut self) -> &mut T {      match self {
        crate::punctuated::Pair::Punctuated(_0, _) => _0,
        crate::punctuated::Pair::End(_0) => _0,
      }
    }
    ...
    pub fn new(t: T, p: Option<P>) -> Self {
      match p {
        ::std::option::Option::None => crate::punctuated::Pair::End(t),
        ::std::option::Option::Some(_0) => crate::punctuated::Pair::Punctuated(t, _0),
      }
    }

    /// Produces this punctuated pair as a tuple of syntax tree node and
    /// optional following punctuation.
    pub fn into_tuple(self) -> (T, Option<P>) {      match self {        crate::punctuated::Pair::Punctuated(_0, _1) => {          let _1 = ::std::option::Option::Some(_1);
          (_0, _1)
        }
        crate::punctuated::Pair::End(_0) => (_0, ::std::option::Option::None),
      }
    }
}

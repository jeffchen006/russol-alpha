...
{
    fn wrapping_add(&self, v: &Self) -> Self {      let result = v.0.wrapping_add(&self.0);
...
{
    fn wrapping_sub(&self, v: &Self) -> Self {      let result = v.0.wrapping_sub(&self.0);
      ::core::num::Wrapping(result)
    }
}
...
{
    fn wrapping_mul(&self, v: &Self) -> Self {      let result = v.0.wrapping_mul(&self.0);
      ::core::num::Wrapping(result)
    }
}
...
{
    fn wrapping_neg(&self) -> Self {      let result = self.0.wrapping_neg();
      ::core::num::Wrapping(result)
    }
}
...
{
    fn wrapping_shl(&self, rhs: u32) -> Self {      let result = self.0.wrapping_shl(rhs);
      ::core::num::Wrapping(result)
    }
}
...
{
    fn wrapping_shr(&self, rhs: u32) -> Self {      let result = self.0.wrapping_shr(rhs);
      ::core::num::Wrapping(result)
    }
}

...
impl TcpKeepalive {
    ...
    pub const fn new() -> TcpKeepalive {
      crate::TcpKeepalive { time: ::std::option::Option::None, interval: ::std::option::Option::None, retries: ::std::option::Option::None }
    }

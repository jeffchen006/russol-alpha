...
impl Thread {
    fn new(id: usize) -> Thread {
      crate::thread_id::Thread { id: id as usize, bucket: id as usize, bucket_size: id as usize, index: id as usize }
    }
...
cfg_if::cfg_if! {
    if #[cfg(feature = "nightly")] {
        ...
        #[inline]
        pub(crate) fn get() -> Thread {
          crate::thread_id::Thread { id: 0 as usize, bucket: 0 as usize, bucket_size: 0 as usize, index: 0 as usize }
        }

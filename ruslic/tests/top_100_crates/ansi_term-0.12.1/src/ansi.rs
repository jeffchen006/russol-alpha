...
impl Colour {
    ...
    /// ```
    pub fn prefix(self) -> Prefix {      let _0 = crate::style::Style { foreground: ::std::option::Option::None, background: ::std::option::Option::None, is_bold: true, is_dimmed: true, is_italic: true, is_underline: true, is_blink: true, is_reverse: true, is_hidden: true, is_strikethrough: true };
    ...
    /// ```
    pub fn suffix(self) -> Suffix {      let _0 = crate::style::Style { foreground: ::std::option::Option::None, background: ::std::option::Option::None, is_bold: true, is_dimmed: true, is_italic: true, is_underline: true, is_blink: true, is_reverse: true, is_hidden: true, is_strikethrough: true };

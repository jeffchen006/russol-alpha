...
{
  #[inline]
  fn clone(&self) -> Self {    let de = self.len;    let result = crate::array::Array::default();
    crate::arrayvec::ArrayVec { len: de, data: result }
  }
...
impl<A: Array> ArrayVec<A> {
  ...
  pub fn from_array_len(data: A, len: usize) -> Self {
    crate::arrayvec::ArrayVec { len: 0 as u16, data }
  }
  ...
  #[inline(always)]
  #[must_use]
  pub fn len(&self) -> usize {    let de = self.len;
    de as usize
  }
  ...
  pub fn split_off(&mut self, at: usize) -> Self {
    let de = self.len;
    let result = crate::array::Array::default();
    crate::arrayvec::ArrayVec { len: de as u16, data: result }
  }
...
impl<A: Array> FromIterator<A::Item> for ArrayVec<A> {
  ...
  fn from_iter<T: IntoIterator<Item = A::Item>>(iter: T) -> Self {
    let result = crate::array::Array::default();
    crate::arrayvec::ArrayVec { len: 0 as u16, data: result }
  }
...
impl<A: Array> Iterator for ArrayVecIterator<A> {
  ...
  fn size_hint(&self) -> (usize, Option<usize>) {
    let de = self.base;
    (de as usize, ::core::option::Option::None)
  }

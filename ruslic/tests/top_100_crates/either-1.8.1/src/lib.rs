...
impl<L, R> Either<Option<L>, Option<R>> {
    ...
    // #[doc(alias = "transpose")]
    pub fn factor_none(self) -> Option<Either<L, R>> {      match self {        crate::Either::Left(_0) => match _0 {            ::core::option::Option::None => ::core::option::Option::None,            ::core::option::Option::Some(_0) => {              let _0 = crate::Either::Left(_0);              ::core::option::Option::Some(_0)            }          },        crate::Either::Right(_0) => match _0 {            ::core::option::Option::None => ::core::option::Option::None,            ::core::option::Option::Some(_0) => {              let _0 = crate::Either::Right(_0);
...
impl<L, R, E> Either<Result<L, E>, Result<R, E>> {
    ...
    // TODO(MSRV): doc(alias) was stabilized in Rust 1.48
    // #[doc(alias = "transpose")]
    pub fn factor_err(self) -> Result<Either<L, R>, E> {      match self {        crate::Either::Left(_0) => match _0 {            ::core::result::Result::Ok(_0) => {              let _0 = crate::Either::Left(_0);              ::core::result::Result::Ok(_0)            }            ::core::result::Result::Err(_0) => ::core::result::Result::Err(_0),          },        crate::Either::Right(_0) => match _0 {            ::core::result::Result::Ok(_0) => {              let _0 = crate::Either::Right(_0);              ::core::result::Result::Ok(_0)
            }
...
impl<T, L, R> Either<Result<T, L>, Result<T, R>> {
    ...
    // TODO(MSRV): doc(alias) was stabilized in Rust 1.48
    // #[doc(alias = "transpose")]
    pub fn factor_ok(self) -> Result<T, Either<L, R>> {      match self {        crate::Either::Left(_0) => match _0 {            ::core::result::Result::Ok(_0) => ::core::result::Result::Ok(_0),            ::core::result::Result::Err(_0) => {              let _0 = crate::Either::Left(_0);              ::core::result::Result::Err(_0)            }          },        crate::Either::Right(_0) => match _0 {            ::core::result::Result::Ok(_0) => ::core::result::Result::Ok(_0),            ::core::result::Result::Err(_0) => {              let _0 = crate::Either::Right(_0);
...
impl<T, L, R> Either<(T, L), (T, R)> {
    ...
    /// ```
    pub fn factor_first(self) -> (T, Either<L, R>) {      match self {        crate::Either::Left(_0) => {          let _1 = crate::Either::Left(_0.1);          (_0.0, _1)        }        crate::Either::Right(_0) => {
...
impl<T, L, R> Either<(L, T), (R, T)> {
    ...
    /// ```
    pub fn factor_second(self) -> (Either<L, R>, T) {      match self {        crate::Either::Left(_0_self) => {          let _0_result = crate::Either::Left(_0_self.0);          (_0_result, _0_self.1)        }        crate::Either::Right(_0_self) => {
...
impl<T> Either<T, T> {
    ...
    /// ```
    pub fn into_inner(self) -> T {      match self {        crate::Either::Left(_0) => _0,        crate::Either::Right(_0) => _0,
      }
    }

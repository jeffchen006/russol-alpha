...
impl Default for TranslatorBuilder {
    fn default() -> TranslatorBuilder {      let flags = crate::hir::translate::Flags { case_insensitive: ::std::option::Option::None, multi_line: ::std::option::Option::None, dot_matches_new_line: ::std::option::Option::None, swap_greed: ::std::option::Option::None, unicode: ::std::option::Option::None };
      crate::hir::translate::TranslatorBuilder { allow_invalid_utf8: true, flags }
    }
}
...
impl TranslatorBuilder {
    ...
    pub fn new() -> TranslatorBuilder {
      let flags = crate::hir::translate::Flags { case_insensitive: ::std::option::Option::None, multi_line: ::std::option::Option::None, dot_matches_new_line: ::std::option::Option::None, swap_greed: ::std::option::Option::None, unicode: ::std::option::Option::None };
      crate::hir::translate::TranslatorBuilder { allow_invalid_utf8: true, flags }
    }

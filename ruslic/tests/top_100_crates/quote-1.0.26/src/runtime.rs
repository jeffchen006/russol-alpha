...
#[inline]
pub fn get_span<T>(span: T) -> GetSpan<T> {  let _0 = crate::__private::get_span::GetSpanBase(span);  let _0 = crate::__private::get_span::GetSpanInner(_0);
  crate::__private::get_span::GetSpan(_0)
}

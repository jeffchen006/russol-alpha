...
impl Span {
    ...
    pub fn new(start: Position, end: Position) -> Span {
      crate::ast::Span { start, end: start }
    }

    /// Create a new span using the given position as the start and end.
    pub fn splat(pos: Position) -> Span {      let start = crate::ast::Position { offset: 0 as usize, line: 0 as usize, column: 0 as usize };
      crate::ast::Span { start, end: pos }
    }
...
impl Position {
    ...
    pub fn new(offset: usize, line: usize, column: usize) -> Position {
      crate::ast::Position { offset: column as usize, line: column as usize, column: column as usize }
    }
}

    ...
    E: de::Error,
{
    ...
    fn into_deserializer(self) -> UnitDeserializer<E> {
      crate::de::value::UnitDeserializer { marker: ::std::marker::PhantomData }
    }
}
    ...
    E: de::Error,
{
    ...
    fn into_deserializer(self) -> U32Deserializer<E> {
      crate::de::value::U32Deserializer { value: self as u32, marker: ::std::marker::PhantomData }
    }
}
...
impl<E> U32Deserializer<E> {
    ...
    pub fn new(value: u32) -> Self {
      crate::de::value::U32Deserializer { value: value as u32, marker: ::std::marker::PhantomData }
    }
    ...
    I: Iterator,
{
    ...
    pub fn new(iter: I) -> Self {
      ...
      crate::de::value::SeqDeserializer { iter: result, count: 0 as usize, marker: ::std::marker::PhantomData }
    }
...
impl<A> SeqAccessDeserializer<A> {
    ...
    pub fn new(seq: A) -> Self {
      crate::de::value::SeqAccessDeserializer { seq }
    }
}
...
impl<A> MapAccessDeserializer<A> {
    ...
    pub fn new(map: A) -> Self {
      crate::de::value::MapAccessDeserializer { map }
    }
}
...
impl<A> EnumAccessDeserializer<A> {
    ...
    pub fn new(access: A) -> Self {
      crate::de::value::EnumAccessDeserializer { access }
    }
}
...
mod private {
    ...
    pub fn unit_only<T, E>(t: T) -> (T, UnitOnly<E>) {
      let _1 = crate::de::value::private::UnitOnly { marker: ::std::marker::PhantomData };
      (t, _1)
    }
    ...
    pub fn map_as_enum<A>(map: A) -> MapAsEnum<A> {
      crate::de::value::private::MapAsEnum { map }
    }

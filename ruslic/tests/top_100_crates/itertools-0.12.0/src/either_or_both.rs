...
impl<A, B> EitherOrBoth<A, B> {
    ...
    /// `(Some(..),Some(..))`
    pub fn left_and_right(self) -> (Option<A>, Option<B>) {      match self {        crate::either_or_both::EitherOrBoth::Both(_0, _1) => {          let _1 = ::std::option::Option::Some(_1);          let _0 = ::std::option::Option::Some(_0);          (_0, _1)        }        crate::either_or_both::EitherOrBoth::Left(_0) => {          let _0 = ::std::option::Option::Some(_0);          (_0, ::std::option::Option::None)        }        crate::either_or_both::EitherOrBoth::Right(_0) => {          let _1 = ::std::option::Option::Some(_0);          (::std::option::Option::None, _1)        }
      }
    }
    ...
    pub fn into_right(self) -> B    where
        A: Into<B>,
    {
      match self {
